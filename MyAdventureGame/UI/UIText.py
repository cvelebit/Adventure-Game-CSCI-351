    ...
    def __init__(self, element=None):
        if element != None:
            ...
            if txt_el != None:
                ...
                self.font = pygame.font.SysFont(self.font_name, self.size) #actually builds image and does a quick lookup does render with text and color with lookup
